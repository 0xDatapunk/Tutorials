...
rule uniqueManager(uint256 fundId1, uint256 fundId2, method f) {
	...
	require getCurrentManager(fundId1)==0 || (getCurrentManager(fundId1) != 0 && isActiveManager(getCurrentManager(fundId1)));
	require getCurrentManager(fundId2)==0 || (getCurrentManager(fundId2) != 0 && isActiveManager(getCurrentManager(fundId2)));
	require getCurrentManager(fundId1)==0 || getCurrentManager(fundId2) == 0 || getCurrentManager(fundId1) != getCurrentManager(fundId2);
	...
	assert getCurrentManager(fundId1)==0 || (getCurrentManager(fundId1) != 0 && isActiveManager(getCurrentManager(fundId1)));
	assert getCurrentManager(fundId2)==0 || (getCurrentManager(fundId2) != 0 && isActiveManager(getCurrentManager(fundId2)));
	assert getCurrentManager(fundId1)==0 || getCurrentManager(fundId2) == 0 || getCurrentManager(fundId1) != getCurrentManager(fundId2);
}
